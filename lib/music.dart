...
class _MusicHomePageState extends State<MusicHomePage> {
  ...
  void initState() {
    super.initState();
    _controllers.add(
      VideoPlayerController.asset('videos/cocomelon_song.mp4')
        ..initialize().then((_) {
          setState(() {});
        }),
    );
    ...
    _controllers.add(
      VideoPlayerController.asset('videos/abc_song.mp4')
        ..initialize().then((_) {
          setState(() {});
        }),
    );
    ...
    _controllers.add(
      VideoPlayerController.asset('videos/song3.mp4')
        ..initialize().then((_) {
          setState(() {});
        }),
    );
              ...
              child: SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  label: Padding(
                    ...
                    child: Text(
                      "Select your songs from the given options",
